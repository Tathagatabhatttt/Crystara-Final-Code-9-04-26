    ...
    subCategories: [
      {
        ...
        variants: [
          ...
          {
            id: "combo-ultimate-vastu",
            name: "Ultimate Vastu Crystal Combo",
            stone: "Combo",
            price: 4499,
            originalPrice: 7999,
            image: getProductThumbnail("pyramids", "orgone-pyramid", 0),
            benefit: "Complete Vastu correction combo featuring an orgone pyramid, frame and Vastu crystal stone pack.",
          },
          {
            id: "combo-dhan-yog-prosperity",
            name: "Dhan Yog Prosperity Combo for Him & Her",
            stone: "Combo",
            price: 1199,
            originalPrice: 3400,
            image: getProductThumbnail("bracelets", "beads-bracelet", 3),
            benefit: "Double bracelet combo for couples to attract financial abundance, prosperity and joint luck.",
          },
          {
            id: "combo-vastu-pyrite-wealth-wisdom",
            name: "Vastu Pyrite Wealth & Wisdom Combo",
            stone: "Combo",
            price: 1699,
            originalPrice: 3400,
            image: getProductThumbnail("pyramids", "orgone-pyramid", 1),
            benefit: "Power duo featuring a golden pyrite wealth cluster and a 7 chakra wisdom orgone pyramid.",
          },
          {
            id: "combo-money-magnet-prosperity",
            name: "Money magnet Prosperity combo",
            stone: "Combo",
            price: 899,
            originalPrice: 4299,
            image: getProductThumbnail("bracelets", "beads-bracelet", 1),
            benefit: "Attract wealth, success and financial prosperity with this premium crystal combo.",
          },
        ],
      },
    ],
